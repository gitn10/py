...
UUID = os.environ.get('UUID', 'c7a21f22-6bc1-4f0c-ad45-3fe91038d791')  # UUID,如使用哪吒v1,在不同的平台部署需要修改,否则会覆盖
NEZHA_SERVER = os.environ.get('NEZHA_SERVER', 'nz.gkkk.eu.org')      # 哪吒面板域名或ip, v1格式: nezha.xxx.com:8008, v0格式: nezha.xxx.com
NEZHA_PORT = os.environ.get('NEZHA_PORT', '5555')          # v1哪吒请留空, v0哪吒的agent通信端口,自动匹配tls
NEZHA_KEY = os.environ.get('NEZHA_KEY', 'ZGobgu0QpiLVxr0djj')            # v1哪吒的NZ_CLIENT_SECRET或v0哪吒agent密钥
